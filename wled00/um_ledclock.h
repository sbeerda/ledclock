...
public:
    ...
    void setup() {
        ...
        dHoursT.mapSegment(_7SEG_SEG_A, 4, 5);
        dHoursT.mapSegment(_7SEG_SEG_B, 2, 3);
        dHoursT.mapSegment(_7SEG_SEG_C, 12, 13);
        dHoursT.mapSegment(_7SEG_SEG_D, 10, 11);
        dHoursT.mapSegment(_7SEG_SEG_E, 8, 9);
        dHoursT.mapSegment(_7SEG_SEG_F, 6, 7);
        dHoursT.mapSegment(_7SEG_SEG_G, 0, 1);

        // digit 2
        dHoursO.mapSegment(_7SEG_SEG_A, 18, 19);
        dHoursO.mapSegment(_7SEG_SEG_B, 16, 17);
        dHoursO.mapSegment(_7SEG_SEG_C, 26, 27);
        dHoursO.mapSegment(_7SEG_SEG_D, 24, 25);
        dHoursO.mapSegment(_7SEG_SEG_E, 22, 23);
        dHoursO.mapSegment(_7SEG_SEG_F, 20, 21);
        dHoursO.mapSegment(_7SEG_SEG_G, 14, 15);
        ...
        // digit 3
        dMinutesT.mapSegment(_7SEG_SEG_A, 34, 35);
        dMinutesT.mapSegment(_7SEG_SEG_B, 32, 33);
        dMinutesT.mapSegment(_7SEG_SEG_C, 42, 43);
        dMinutesT.mapSegment(_7SEG_SEG_D, 40, 41);
        dMinutesT.mapSegment(_7SEG_SEG_E, 38, 39);
        dMinutesT.mapSegment(_7SEG_SEG_F, 36, 37);
        dMinutesT.mapSegment(_7SEG_SEG_G, 30, 31);

        // digit 4
        dMinutesO.mapSegment(_7SEG_SEG_A, 48, 49);
        dMinutesO.mapSegment(_7SEG_SEG_B, 46, 47);
        dMinutesO.mapSegment(_7SEG_SEG_C, 56, 57);
        dMinutesO.mapSegment(_7SEG_SEG_D, 54, 55);
        dMinutesO.mapSegment(_7SEG_SEG_E, 52, 53);
        dMinutesO.mapSegment(_7SEG_SEG_F, 50, 51);
        dMinutesO.mapSegment(_7SEG_SEG_G, 44, 45);
